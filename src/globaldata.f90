! **************************************************************************************
!|
! Global variable definitions for CDE.
!
! **************************************************************************************
...
Module globaldata
  ...
  integer :: Natomconstr          !! Number of constrained atoms.
  ...
  !> Type definition for the parameters used in the graphfinder algorithm.
  type GraphPar
   ...
   integer              :: maxisosteps          !! the maximum number of isomerization reactions per isomer group that can be found in the reaction trees
  ...
  integer                          :: moleculemax         !! Maximum number of fragments/molecules allowed to form
