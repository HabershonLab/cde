...
- **nebrestrend .FALSE.** :: Flag indicating weather to apply to it duing the optimization of molecules during GDS, if *optaftermove .TRUE.* (also used in CINEB).
